...
if (isset($_SESSION['user_id']) && 
    ...
    /* --- FETCH SETTING (Table name: setting) --- */
...
<head>
    <meta charset="UTF-8">
    <title>Manager - Vehicle Management</title>
...
<body class="bg-light">
    ...
    <script>
        ...
        function editCategory(id, name) {
            // Change form destination back to this page for updates
        ...
        function resetCatForm() {
            // Reset form destination to the add script
