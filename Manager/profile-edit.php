...
<head>
    <meta charset="UTF-8">
    <title>Edit Manager Profile | Garage HQ</title>
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.0/dist/css/bootstrap.min.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    <style>
        body { background-color: #f8f9fa; }
        /* Slightly wider container as requested */
...
<body>
    ...
    <div class="container edit-container mb-5">
        <div class="card shadow-sm p-4 bg-white">
            <div class="text-center mb-4">
                ...
                <p class="text-muted small">Update your administrative account information</p>
            </div>
            ...
            <form action="req/profile-edit.php" method="post">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="fname" class="form-control" value="<?php echo $manager['fname']; ?>" required>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label small fw-bold">Last Name</label>
                        <input type="text" name="lname" class="form-control" value="<?php echo $manager['lname']; ?>" required>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="email" name="email_address" class="form-control" value="<?php echo $manager['email_address']; ?>" required>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label small fw-bold">Phone Number</label>
                        <input type="text" name="phone_number" class="form-control" value="<?php echo $manager['phone_number']; ?>">
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="password" name="old_password" class="form-control" placeholder="Enter current password to verify" required>
                </div>
    ...
    function generatePassword() {
        ...
        // Using a basic for loop as per your preference
        ...
        // Briefly change type to text so user can see it, then back to password
        var passInput = document.getElementById("new_pass");
        passInput.type = "text";
        setTimeout(function(){ passInput.type = "password"; }, 3000);
        
        alert("Generated Password: " + password + "\n\nIt will be visible for 3 seconds.");
    }
    </script>
</body>
</html>
