                    ...
                    <div class="col-md-6 ps-md-4">
                        <form id="mainUpdateForm" action="req/repair-update.php" method="post">
                            ...
                            <?php } else if ($repair['status'] == 'Inspecting' || $repair['status'] == 'Repairing') { ?>
                                <div class="mb-3">
                                    <label class="form-label fw-bold small">Technician Notes</label>
                                ...
                                <div class="row g-2 mb-4">
                                    <div class="col-6">
                                        ...
                                        <input type="number" step="0.01" name="labor_fee" class="form-control" value="<?php echo $repair['labor_fee']; ?>" <?php echo ($repair_type == 'Service' || !$can_edit_details) ? 'readonly' : ''; ?>>
                                    </div>
                                    <div class="col-6">
                            ...
                            <?php } else if ($repair['status'] == 'Canceled') { ?>
                                <div class="text-center py-5">
                                    ...
                                    <p class="small text-muted">This job was canceled.</p>
                                </div>
                            <?php } else { ?>
                                <div class="text-center py-5">
